...
export const dictionaries: Record<Locale, Dict> = {
  ...
  sk: {
    nav: {
      ...
      pearls: "Perly",
      wedding: "Obrúčky",
      signature: "Charakteristický štýl",
      diamonds: "Diamanty",
      design: "Dizajn",
  ...
  cs: {
    nav: {
      ...
      signature: "Charakteristický styl",
      diamonds: "Diamanty",
      design: "Design",
  ...
  pl: {
    nav: {
      ...
      pearls: "Perły",
      wedding: "Obrączki",
      signature: "Charakterystyczny styl",
      diamonds: "Diamenty",
      design: "Design",
